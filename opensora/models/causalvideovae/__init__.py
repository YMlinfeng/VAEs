...
class WFVAEModelWrapper(nn.Module):
    def __init__(self, model_path, subfolder=None, cache_dir=None, **kwargs):
        ...
        print("Loaded config latent_dim:", self.vae.config.latent_dim)
        print("Loaded config shift:", self.vae.config.shift)
        print("Loaded config:", self.vae.config)
...
ae_wrapper = {
    ...
    'WFVAEModel_D4_4x8x8': WFVAEModelWrapper,
...
ae_denorm = {
    ...
    'WFVAEModel_D4_4x8x8': lambda x: (x + 1.) / 2.,
...
ae_norm = {
    ...
    'WFVAEModel_D4_4x8x8': Lambda(lambda x: 2. * x - 1.),
